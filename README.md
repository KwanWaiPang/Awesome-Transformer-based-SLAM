...
| Year | Venue | Paper Title | Repository | Note |
|:----:|:-----:| ----------- |:----------:|:----:|
|2026|`CVPR`|[LiteVGGT: Boosting Vanilla VGGT via Geometry-aware Cached Token Merging](https://arxiv.org/pdf/2512.04939)|[![Github stars](https://img.shields.io/github/stars/GarlicBa/LiteVGGT-repo.svg)](https://github.com/GarlicBa/LiteVGGT-repo)|[website](https://garlicba.github.io/LiteVGGT/)提出了一种geometry-aware token merging策略，使得原本的VGGT可以处理1000张图，推理加速10倍|
